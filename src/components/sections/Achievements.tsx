  ...
  return (
    ...
    >
      <div className="relative h-full p-8 rounded-2xl glass overflow-hidden">
        ...
        >
          <div className="p-3 rounded-xl bg-gradient-to-br from-[#00f0ff]/20 to-[#a855f7]/20 border border-[#00f0ff]/30">
        ...
        {/* Content */}
        <h3 className="text-xl font-bold text-white mb-2 pr-16 group-hover:text-[#00f0ff] transition-colors">
          {achievement.title}
        </h3>
        <p className="text-[#00f0ff]/80 text-sm mb-3">{achievement.organization}</p>
        ...
        {selectedAchievement && (
          ...
          >
            ...
            >
              ...
              <div className="mb-6">
                <div className="inline-block p-4 rounded-2xl bg-gradient-to-br from-[#00f0ff]/20 to-[#a855f7]/20 border border-[#00f0ff]/30 mb-4">
                  {(() => {
                    const Icon = iconMap[selectedAchievement.icon as keyof typeof iconMap];
                    return <Icon className="w-8 h-8 text-[#00f0ff]" />;
                  })()}
                </div>
                <span className="text-[#00f0ff]/80 text-sm block mb-2">
