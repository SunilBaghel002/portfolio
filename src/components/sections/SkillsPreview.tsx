  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="text-xs text-accent-neon ml-2">{skill.level}%</span>
      </motion.div>
    </motion.div>
  );
}
    ...
    <section ref={containerRef} className="py-32 relative overflow-hidden">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="relative h-[500px] flex items-center justify-center mb-16">
          {/* Center decoration */}
          <motion.div
            className="absolute w-40 h-40 rounded-full bg-gradient-to-br from-accent-neon/20 to-accent-purple/20 flex items-center justify-center"
            style={{ rotate }}
          >
            <Sparkles className="w-12 h-12 text-accent-neon" />
          </motion.div>
      ...
      {/* Background */}
      <div className="absolute top-1/2 right-0 w-96 h-96 bg-accent-neon/5 rounded-full blur-[128px] pointer-events-none -translate-y-1/2" />
    </section>
  );
}